...
const Navbar = () => {
    ...
    const navLinks = <>
        ...
        <li><NavLink data-aos="fade-down" data-aos-duration="1000" data-aos-delay="1000" className="mr-3" to="/register">Register</NavLink></li>
        {
            user ?
                <div className="flex">
                    <li><NavLink data-aos="fade-down" data-aos-duration="1000" data-aos-delay="500" className="mr-3" to="/addSpots">Add spot</NavLink></li>
            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <div data-aos="fade-right" data-aos-duration="1000">
                        <a className="btn btn-ghost text-lg lg:text-2xl font-permanentMarker text-[tomato]">Easy <span className="text-xl">Tour</span></a>
                    </div>
                </div>
